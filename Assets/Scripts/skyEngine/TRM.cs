...
public class TRM // Info Manager
{
    ...
    public static void NewGame(JSONNode slotInfo)
    {
        ...
        TextAsset pathStringBuildInfoAdd = Resources.Load("missions/" + GM.missionPath + "/config/BuildInfo") as TextAsset;
        ...
        TextAsset pathStringBattleUnitAdd = Resources.Load("missions/" + GM.missionPath + "/config/BattleUnitAdd") as TextAsset;
